...
| Provides    | GET /prototypes/list, GET /prototypes |
...
- Should status badges on this screen be clickable to cycle status? Read-only here — status changes go through SCREEN-PROJECTS-DETAIL or the Dashboard.
