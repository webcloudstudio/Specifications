...
#
# Usage:
#   bash bin/generate_prompt.sh <project-name>                    # Print to stdout
#   bash bin/generate_prompt.sh <project-name> > build-prompt.md  # Save to file
#
# Example:
...
PROJECT_NAME="${1:?Usage: bash bin/generate_prompt.sh <project-name>}"
