# Prototyper — Rapid Project Development

A tool for project owners managing AI-assisted prototypes.
...
```bash
bash ../bin/validate.sh Prototyper
bash ../bin/build.sh Prototyper > build-prompt.md
```

The generated prompt includes all stack reference files followed by all specification files. An AI agent reading this prompt has everything needed to build Prototyper from scratch.
